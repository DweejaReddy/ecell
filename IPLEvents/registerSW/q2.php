...
<body>
    <div class="container d-flex justify-content-center pt-3 shadow-lg p-3 mb-5 bg-white rounded">
        <div class="row">
            <form class="p-4" method="post" action="store_details_q2.php">
                <div class="card-heading text-center">
                    <h1 class="title pb-2">Registration</h1>
                    <hr>
                </div>
                <div class="form-group row">
                    <label for="story" class="col-md-4 col-form-label">What’s your startup story? (How did you get the idea, team building, etc.) *</label>
                    <div class="col-md-8">
                        <input type="text" class="form-control rounded-pill" name="story" placeholder="Enter Details" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="domain" class="col-md-4 col-form-label">Your idea focuses on which domain? *</label>
                    <div class="col-md-8">
                        <input type="text" class="form-control rounded-pill" name="domain" placeholder="Enter Domain Name" required>
                        <!-- <small class="form-text">Please note down this email for payment purpose!</small> -->
                    </div>
                </div>
                <div class="form-group row">
                    <label for="link" class="col-md-4 col-form-label">Drive link or dropbox of your pitch deck/Concept note, website  : *</label>
                    <div class="col-md-8">
                        <input type="text" class="form-control rounded-pill" name="link" placeholder="Drive/Dropbox Link" required>
                        <!-- <small class="form-text">Please note down this email for payment purpose!</small> -->
                    </div>
                </div>
                <div class="form-group row">
