...
<body>
    <div class="container d-flex justify-content-center pt-3 shadow-lg p-3 mb-5 bg-white rounded">
        <div class="row">
            <form class="p-4" method="post" action="store_details_q1.php">
                <div class="card-heading text-center">
                    <h1 class="title pb-2">Registration</h1>
                    <hr>
                </div>
                <div class="form-group row">
                    <label for="story" class="col-md-4 col-form-label">Tell us your startup story*</label>
                    <div class="col-md-8">
                        <input type="text" class="form-control rounded-pill" name="story" placeholder="Enter details" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="link" class="col-md-4 col-form-label">Any of your website/app/blog Link *</label>
                    <div class="col-md-8">
                        <input type="text" class="form-control rounded-pill" name="link" placeholder="Website/App/Blog Link" required>
                        <!-- <small class="form-text">Please note down this email for payment purpose!</small> -->
                    </div>
                </div>
                <div class="form-group row">
                    <label for="size" class="col-md-4 col-form-label">Team Size? (1 to 4) *</label>
                    <div class="col-md-8">
                        <input type="number" class="form-control rounded-pill" name="size" placeholder="Enter Team Size" required>
                    </div>
                </div>
                <div class="form-group row">
