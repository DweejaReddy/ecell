    ...
    <div class="row">
      ...
      <div class="col-md-5 col-sm-12 col-xs-12">
        <p class="iplPara pl-2 text-left mb-2">
          ...
          <br><br><small class="mt-5">Already Registered? <a style="height:40px; font-size:15px;" class="btn btn-light rounded-pill" href="paymentPortalipl/checkemail.php">Proceed to Payment <img style="height:16px;" src="https://img.icons8.com/windows/32/000000/enter-2.png"/></a></small>
        </p>
      </div>
    </div>
  </section>
