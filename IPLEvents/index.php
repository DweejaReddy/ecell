...
<head>
  ...
  <link href="ecellcss/overlay.css" rel="stylesheet">
  <link href="ecellcss/global/global.css" rel="stylesheet">
  <!-- Required meta tags -->
  <meta charset="utf-8">
...
<body>
  ...
  <section>
    <div class="container">
      <br><br>
      <div class="container d-flex justify-content-center align-items-center">
        <h4 style="color: #bd2026; font-family: 'Lato', sans-serif; font-weight: 700;" class="text-uppercase g-font-size-20--xs g-font-weight--700 g-letter-spacing--2 g-margin-b-25--xs">ABOUT</h4>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-sm-12 col-xs-12">
          <p class="para">
            We at E-Cell VNIT serve the purpose of fostering a community of contemporary as well as seasoned
            entrepreneurs by organising expert talks, webinars, workshops, light skill development events as well as
            highly rewarding competitions, pitching scenarios and much more throughout the year. Besides this, we have
            been mentoring new and budding start-ups across the country and at the same time, invoking a sense of
            responsibility in students towards the nation by empowering social start-ups as well.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-md-11 col-sm-12 col-xs-12">
        ...
        be moulded and paths will be guided to enforce a healthy startup culture. <br><br>
          ...
          <a class="btn btn-light rounded-pill " href="https://drive.google.com/file/d/13TsqeavzfuUCBl7Lud5jgrzWh_o3qdlH/view?usp=sharing" style="margin-left: 2vh;">Download Brochure <img style="height:20px;" src="https://img.icons8.com/material-outlined/24/000000/download--v2.png"/></a>
          <!-- <br><br><small class="mt-5">Already Registered? <a style="height:40px; font-size:15px;" class="btn btn-light rounded-pill" href="https://pmny.in/wIsLpSBch7kO">Proceed to Payment <img style="height:16px;" src="https://img.icons8.com/windows/32/000000/enter-2.png"/></a></small> -->
        </p>
      </div>
    </div>
  ...
  <footer class="g-bg-color--dark">
    ...
    <div class="container g-padding-y-30--xs">
      ...
      <div class="footer-row">
        ...
        <div class="col-sm-12 col-md-3 col-lg-3">
          ...
          <a href="https://consortium.ecellvnit.org/" target="_blank"
            class="g-color--white-opacity-light footer-para g-font-size-16--xs">
        ...
        <div class="col-sm-12 col-md-3 col-lg-3">
          ...
          <a href="https://store.ecellvnit.org/" target="_blank"
            class="g-color--white-opacity-light footer-para g-font-size-16--xs">
        ...
        <div class="col-sm-12 col-md-3 col-lg-3">
          ...
          <a href="https://consortium.ecellvnit.org/expo.php" target="_blank"
            class="g-color--white-opacity-light footer-para g-font-size-16--xs">
    ...
    <div class="container" style="padding-top:22px">
      ...
      <div class="footer-row">
        ...
        <div class="col-md-3">
          <div>
            <img src="https://startupconclave.ecellvnit.org/static/img/E-Cell_white.png" alt="" height="80"
        ...
        <div class="col-md-3">
          ...
          <p class="g-color--white-opacity-light">For Association and
            Sponsorship:<br><strong>associate@ecellvnit.org</strong></p>
        </div>
        ...
        <div class="col-md-3">
          ...
          <div class="hosting-partner-image-container">
            <a href="https://www.znetlive.com/">
              <img src="ecellimg/znetlive.png" alt="hosting partner - znet">
            </a>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-sm-12" style="position:relative; text-align:center">
          <p class="g-font-size-14--xs g-margin-b-0--xs g-color--white-opacity g-padding-y-20--md">&copy;
