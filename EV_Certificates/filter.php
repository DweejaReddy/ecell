...
$con = mysqli_connect("localhost","ias2020","ecell123","evEntries");
...
if (isset($_POST['certificate_form'])) {
  ...
  $checkUser = "SELECT * FROM registrations_1_copy where contact = '$contact'";
  ...
  if ($count < 1) {
    ...
    $image = @imagecreatefromjpeg("cert_template.jpeg");
    $output = "certificate.jpeg";
    ...
    $pdf->Output('D', "EV_certificate_$name.pdf");
