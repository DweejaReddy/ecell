        ...
        <div class="container d-flex align-items-center justify-content-center min-vh-100">
            <div class="row text-center">
                <div class="pt-5 pb-3 px-4 d-lg-block d-none text-center" style="background-color: white;border-radius: 10px;">
                  <?php echo "<h4 style=font-weight: 600;>Your Query has been recorded. <br> We will get back to you soon.</h4>";?><br>
                </div>
                <div class="pt-5 pb-3 px-3 d-lg-none d-block text-center" style="background-color: white;border-radius: 10px;">
                  <?php echo "<p style=font-weight: 600;font-size:4vw;>Your Query has been recorded. <br> We will get back to you soon.</p>";?><br>
                </div>
            </div>
            <!-- <br> -->
            <div class="row text-center">
