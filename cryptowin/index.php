...
<html lang="en">
<head>
    <title>CRYPTOWIN | Consortium '22, E-CELL, VNIT, 2022</title>
</head>
        ...
        <div class="text-center about cont text-white mx-auto my-5 py-5" style="max-width: 80%;" id="managers">
            ...
            <div class="row align-items-center">
                <div class="contactcard col-12 col-md-6 col-lg-4 mx-4" style="height: auto;border-radius: 25px;" data-aos="fade-up" data-aos-duration="2000">
                    <h5 class="mt-2 pt-3">Aryan Mahure</h5>
                    <a class="ml-4" href="https://www.linkedin.com/in/aryan-mahure-5ba135112" target="_blank" >
                        <img id="linkedin" src="img/linkedin_black.png" alt="">
                    </a>
                    <!-- <div class="name">bhargav@gmail.com</div> -->
                    <div class="phone pb-4" style="margin-top: -30px;">+91 93565 14618</div>
                </div>
                <!-- <div class="contactcard col-12 col-md-6 col-lg-4 mx-4" style="height: auto;border-radius: 25px;" data-aos="fade-up" data-aos-duration="2000">
                ...
                <div class="contactcard col-12 col-md-6 col-lg-4 mx-4" style="height: auto;border-radius: 25px;" data-aos="fade-up" data-aos-duration="2000">
                    <h5 class="mt-2 pt-3">Tarun Saraf</h5>
                    <a class="ml-4" href="https://www.linkedin.com/in/tarun-saraf-2107" target="_blank" >
                        <img id="linkedin" src="img/linkedin_black.png" alt="">
                    </a>
                    <div class="phone pb-4" style="margin-top: -30px;">+91 96913 61448</div>
                </div>
                <div class="contactcard col-12 col-md-6 col-lg-4 mx-4" style="height: auto;border-radius: 25px;" data-aos="fade-up" data-aos-duration="2000">
                    <h5 class="mt-2 pt-3">Samruddhi Wagh</h5>
                    <a class="ml-4" href="https://www.linkedin.com/in/samruddhi-wagh-96096b218" target="_blank" >
                        <img id="linkedin" src="img/linkedin_black.png" alt="">
                    </a>
                    <div class="phone pb-4" style="margin-top: -30px;">+91 78418 60535</div>
                </div>
                <!-- <div class="contactcard col-12 col-md-6 col-lg-4 mx-4" style="height: auto;border-radius: 25px;" data-aos="fade-up" data-aos-duration="2000">
