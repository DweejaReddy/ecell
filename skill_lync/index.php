...
<html lang="en">
  ...
  <head>
    ...
    <title>Download Skill-Lync Workshop certificate</title>
  ...
  <body style="vertical-align: middle;">
    <header>
        <img src="VectorU.png" width="100%" alt="uppercurve">
    </header>
    ...
    <main class="text-center my-3 text-white">
      <form method="post" action="filter.php">
        ...
        <Button id="submitBtn" type="submit" class="btn btnth mt-3 mb-5" name="certificate_form">Download Certificate</Button>
        <form>
    </main>
    <div class="text-center text-white D">
      <img src="VectorD2.png" class="D2" width="100%" alt="lowergraycurve">
      <img src="VectorD1.png" class="D1" width="100%" alt="lowerbluecurve">
    </div>
  </div>
