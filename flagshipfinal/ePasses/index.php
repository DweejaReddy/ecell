...
<html lang="en">
  ...
  <head>
    ...
    <title>Download Flagship E-Passes</title>
  ...
  <body>
    <header>
      <div class="text-center text-white my-5">
        <img src="Layer 1.png" height="150px" alt="logo">
        <h2 class="mt-5" style="color: #ff4200;">Download your Flagship E-Passes</h2>
      </div>
    </header>
    <main class="text-center my-3 text-white">
      ...
      <form method="post" action="filter.php">
       ...
       <Button id="submitBtn" type="submit" class="btn btnth" name="certificate_form">Download your E-Pass</Button>
        <form>
    </main>
