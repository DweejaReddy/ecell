...
<nav id="mainNavbar" class="navbar navbar-expand-lg navbar-light bg-white shadow sticky-top">
      <div class="container">
      <a class="navbar-brand ml-0" href="index.php"><img src="img/logo-ecell-sm.png" alt="Ecell Logo" ></a>
    ...
    <div class="blog-card jumbotron p-4 p-md-5 text-black rounded bg-light shadow">
      <div class="row pb-2">
        <div class="col-md-4 m-auto text-center">
          ...
          <img class="blog-image " style="border-radius:50%" alt="speaker-1" src="img/karan shah.png">
        </div>
...
<!-- Speaker's Cards end -->
  ...
  <div class="container g-padding-y-10--xs g-padding-y-40--sm" style="background: rgba(255, 255, 255, 1);">
    <div class="row">
        <div class="col-md-12 g-margin-t-15--xs g-margin-b-60--xs g-margin-b-0--lg">
            <div class="underline wow fadeInLeft g-text-center--xs" data-wow-duration=".3" data-wow-delay=".3s">
                <h3 class="text-center g-font-size-32--xs g-font-size-36--sm g-font-size-36--md ">Past <span class="g-color--primary" style="color:#4060B5">Speakers</span></h3>
            </div>
            <hr class="m-auto" style="height:3px; width:40%; border-width:0; color:#4060B5; background-color:#4060B5">
        </div>
    </div>
    
    <div class="row mt-3 " id="hex-guests">
